...
const MobileDesignSolution = () => {
  ...
  // Better mobile scaling - use smaller base sizes instead of CSS scaling
            ...
            <div style={screenStyle}>
              ...
              <div style={contentStyle}>
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: isMobile ? '6px' : '10px', color: '#666', marginBottom: '6px' }}>
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: isMobile ? '6px' : '10px', color: '#856404' }}>
            ...
            <div style={screenStyle}>
              ...
              <div style={contentStyle}>
                <div style={{
                  ...
                  <div style={{ fontSize: isMobile ? '8px' : '12px' }}>🎤</div>
                  <div style={{ fontSize: isMobile ? '7px' : '12px', color: '#155724' }}>
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: isMobile ? '8px' : '13px', fontWeight: '600', marginBottom: '6px' }}>
                    Essay Response
                  </div>
                  <div style={{
                    background: 'white',
                    ...
                    <div style={{
                      ...
                      {transcriptText.substring(0, isMobile ? 80 : 120)}...
                      <span style={{
                  ...
                  <div style={{ fontSize: isMobile ? '6px' : '10px', color: '#666' }}>
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: isMobile ? '7px' : '11px', color: '#155724', fontWeight: '500' }}>
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: isMobile ? '7px' : '11px', fontWeight: '600', marginBottom: '4px', color: '#1976d2' }}>
                    💡 Voice Tips
                  </div>
                  <div style={{ fontSize: isMobile ? '6px' : '9px', color: '#1976d2', lineHeight: 1.3 }}>
